...
export const registerValidator = validate(
  checkSchema({
    ...
    password: {
      ...
      errorMessage:
        'Password must be at least 8 characters long, contain at least 1 lowercase, 1 uppercase, 1 number anf 1 symbol!'
    },
    confirm_password: {
      notEmpty: true,
      isString: true,
      ...
      errorMessage:
        'confirm_password must be at least 8 characters long, contain at least 1 lowercase, 1 uppercase, 1 number anf 1 symbol!',
      custom: {
        //value là confirm pw
        options: (value, { req }) => {
